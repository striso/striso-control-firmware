...
static msg_t ThreadAccel(void *arg) {
  ...
  while (init_succeeded == false) {
    ...
    MPU6050_writeReg(MPU6050_RA_GYRO_CONFIG, MPU6050_GYRO_CONFIG_FS_500); // MPU6050_GYRO_FS_500
    ...
    if (MPU6050_readReg(MPU6050_RA_CONFIG) == MPU6050_DLPF_BW_42 &&
        MPU6050_readReg(MPU6050_RA_GYRO_CONFIG) == MPU6050_GYRO_CONFIG_FS_500 &&
