...
/*
 * Setup for Striso dis v1.92 H743 board.
 */
...
#define BOARD_NAME                  "Striso dis v1.92 H743"
 ...
 */
#define LINE_ADC0                   PAL_LINE(GPIOA, 0U)
#define LINE_ADC1                   PAL_LINE(GPIOA, 1U)
#define LINE_ADC2                   PAL_LINE(GPIOA, 2U)
 ...
 * PA5  - LED1                      (output pushpull maximum).
 * PA6  - PIN6                      (input pullup).
 * PA7  - PIN7                      (input pullup).
 * PA8  - I2C3_SCL                  (input floating).
 * PA9  - UART1_TX                  (input pullup).
 * PA10 - UART1_RX                  (input pullup).
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOA_ADC0) |       \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_ADC0, 0U) |          \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOC_ADC10) |      \
                                     PIN_OSPEED_VERYLOW(GPIOC_ADC11) |      \
                                     PIN_OSPEED_VERYLOW(GPIOC_ADC12) |      \
                                     PIN_OSPEED_VERYLOW(GPIOC_ADC13) |      \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_ADC10, 0U) |         \
                                     PIN_AFIO_AF(GPIOC_ADC11, 0U) |         \
                                     PIN_AFIO_AF(GPIOC_ADC12, 0U) |         \
                                     PIN_AFIO_AF(GPIOC_ADC13, 0U) |         \
