...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow13 = fastpow2((0.083333333333333329f * (fSlow12 + (0.5f * faustpower<3>(float(fslider2))))));
		...
		float 	fSlow18 = max((float(fslider4) + -0.001f), (float)0);
		...
		float 	fSlow21 = max(((faustpower<2>(float(fslider6)) + faustpower<2>(float(fslider5))) + -0.0050000000000000001f), (float)0);
		...
		float 	fSlow44 = fastpow2((0.083333333333333329f * (fSlow43 + (0.5f * faustpower<3>(float(fslider10))))));
		...
		float 	fSlow49 = max((float(fslider12) + -0.001f), (float)0);
		...
		float 	fSlow60 = float(fslider13);
		float 	fSlow61 = float(fslider14);
		...
		float 	fSlow73 = fastpow2((0.083333333333333329f * (fSlow72 + (0.5f * faustpower<3>(float(fslider15))))));
		...
		float 	fSlow78 = max((float(fslider17) + -0.001f), (float)0);
		...
		float 	fSlow89 = float(fslider18);
		float 	fSlow90 = float(fslider19);
		...
		float 	fSlow101 = float(fslider21);
		float 	fSlow102 = fastpow2((0.083333333333333329f * (fSlow101 + (0.5f * faustpower<3>(float(fslider20))))));
		...
		float 	fSlow107 = max((float(fslider22) + -0.001f), (float)0);
